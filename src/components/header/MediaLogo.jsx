export default () => (
    <div className="flex-1 flex justify-end items-end gap-2">
        <a href="https://github.com/CH563/image-beautifier" target="_blank" aria-label="GitHub" class="block rounded-full p-1.5 hover:bg-slate-100">
        ...
        <a href="https://twitter.com/LiWen563" target="_blank" aria-label="twitter:@LiWen563" class="block rounded-full p-1.5 hover:bg-slate-100">
